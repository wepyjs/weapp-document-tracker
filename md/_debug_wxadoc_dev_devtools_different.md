...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/devtools/different.html?t=18092618)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/devtools/different.html?t=18092618)
...
![args](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/pathquery.png?t=18092618)

## 进入场景值

在微信客户端中，用户可能在各个场景下打开小程序 [详情](../framework/app-service/scene.html#场景值) ，然而在开发者工具中是没有真实的环境去模拟这些场景的。开发者可以通过条件编译的方式来达到调试不同场景的目的。

![sence](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/scene.png?t=18092618)
...
![withShareTicket](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/group.png?t=18092618)
...
![withShareTicket](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/shareticket.png?t=18092618)
...
![navigateToMiniProgram](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/navigateminiprogram.png?t=18092618)

选择 **自定义编译** 进入场景选择 **1038 从小程序返回** 可以调试小程序返回时候是否接收到了正确的参数并做了相关处理。

![navigateToMiniProgram](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/navigateminiprogramback.png?t=18092618)
