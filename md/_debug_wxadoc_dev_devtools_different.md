...
![withShareTicket](https://mp.weixin.qq.com/debug/wxadoc/dev/image/devtools/different/4.png?t=2017616)
...
![withShareTicket](https://mp.weixin.qq.com/debug/wxadoc/dev/image/devtools/different/5.png?t=2017616)

## 进入场景值

在微信客户端中，用户可能在各个场景下打开小程序 [详情](../framework/app-service/scene.html#场景值) 然而在开发者工具中是没有真实的环境去模拟这些场景的。开发者可以通过条件编译的方式来达到调试不同场景的目的。

![sence](https://mp.weixin.qq.com/debug/wxadoc/dev/image/devtools/different/1.png?t=2017616)
...
![args](https://mp.weixin.qq.com/debug/wxadoc/dev/image/devtools/different/2.png?t=2017616)
...
![uplodfortest](https://mp.weixin.qq.com/debug/wxadoc/dev/image/devtools/different/3.png?t=2017616)
