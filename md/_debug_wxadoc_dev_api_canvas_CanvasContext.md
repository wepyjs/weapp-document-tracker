...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/canvas/CanvasContext.html?t=18101919)
...
边框颜色。用法同 [CanvasContext.setFillStyle()](CanvasContext.setStrokeStyle.html)。
...
##### [CanvasContext.drawImage(string imageResource, number dx, number dy, number dWidth, number dHeight, number sx, number sy, number sWidth, number sHeight)](CanvasContext.drawImage.html)
