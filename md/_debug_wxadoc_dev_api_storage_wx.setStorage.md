...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/storage/wx.setStorage.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/storage/wx.setStorage.html?t=18111620)
...
<td>需要存储的内容。只支持原生类型、Date、及能够通过`JSON.stringify`序列化的对象。</td>
