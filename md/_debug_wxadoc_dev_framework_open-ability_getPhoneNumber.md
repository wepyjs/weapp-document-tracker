...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/getPhoneNumber.html?t=18101520)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/open-ability/getPhoneNumber.html?t=18101520)
...
获取微信用户绑定的手机号，需先调用[wx.login](../../api/open-api/login/wx.login.html)接口。
...
[](./signature.html)[](./bio-auth.html)</div>
