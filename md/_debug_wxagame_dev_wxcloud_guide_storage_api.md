...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/guide/storage/api.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/guide/storage/api.html?t=18111620)
...
支持在 `image`、`audio` 等组件中传入云文件 ID，具体支持列表见[文档](../../reference-client-api/component/index.html)
...
可以在此参考详细的[小程序端](../../reference-client-api/storage/index.html)存储 API 文档和[服务端](../../reference-server-api/storage/index.html) API 文档
