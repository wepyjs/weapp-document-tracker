...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/guide/database/query.html?t=18092019)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/guide/database/query.html?t=18092019)
...
使用数据库 API 提供的 `where` 方法我们可以构造复杂的查询条件完成复杂的查询任务。在本节中我们还是使用[上一章节](read.html)中使用的示例数据。
...
具体的查询指令 API 文档可参考[数据库 API 文档](../../reference-client-api/database/index.html#command)。
...
具体的逻辑查询指令 API 文档可参考[数据库 API 文档](../../reference-client-api/database/index.html#command)。

在[下一章节](update.html)，我们一起学习如何更新数据。
