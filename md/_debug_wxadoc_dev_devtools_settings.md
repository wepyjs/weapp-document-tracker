...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/devtools/settings.html?t=18110719)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/devtools/settings.html?t=18110719)
...
![appearance](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/setting_appearance.png?t=18110719)
...
![edit](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/setting_edit.png?t=18110719)

### 代理设置

可以配置不使用代理，或使用系统代理，或使用自定义代理。

![proxy](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/setting_proxy.png?t=18110719)
