...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/media/audio/wx.getAvailableAudioSources.html?t=18092914)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/media/audio/wx.getAvailableAudioSources.html?t=18092914)
...
*   [媒体](./wx.stopVoice.html)
    ...
    *   [录音](../recorder/wx.startRecord.html)
...
<td>支持的音频输入源列表，可在 [RecorderManager.start()](../recorder/RecorderManager.start.html) 接口中使用。返回值定义参考 https://developer.android.com/reference/kotlin/android/media/MediaRecorder.AudioSource</td>
...
[](./wx.createInnerAudioContext.html)[](./wx.setInnerAudioOption.html)</div>
