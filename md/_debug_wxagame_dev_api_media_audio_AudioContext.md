...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/media/audio/AudioContext.html?t=18092914)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/media/audio/AudioContext.html?t=18092914)
...
AudioContext 实例，可通过 [wx.createAudioContext](wx.createAudioContext.html) 获取。

`audioContext` 通过 `id` 跟一个 `<audio/>` 组件绑定，操作对应的 `<audio/>` 组件。

#### 方法

##### [AudioContext.setSrc(string src)](AudioContext.setSrc.html)
...
##### [AudioContext.seek(number position)](AudioContext.seek.html)
...
[](./InnerAudioContext.destroy.html)[](./AudioContext.setSrc.html)</div>
