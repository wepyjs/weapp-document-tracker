...
*   [中文](https://developers.weixin.qq.com/minigame/dev/document/midas-payment/midasPresent.html?t=18081820)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/minigame/en/dev/document/midas-payment/midasPresent.html?t=18081820)
...
<td>游戏服务器大区id,游戏不分大区则默认zoneId ="1",String类型。如果应用选择支持角色，则角色ID接在分区ID号后用"_"连接。</td>
