...
*   [中文](https://developers.weixin.qq.com/miniprogram/introduction/widget/quickstart/test/index.html?t=18092916)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/introduction/widget/quickstart/test/index.html?t=18092916)
...
在后台开发完成，并且成功体验之后，可以在**模板与组件 - Widget - 模板管理 - 模板申请单**提交测试。测试包括[导入数据检测](datatest.html)、[后台性能测试](stresstest.html)和[展示效果测试](uitest.html)3个部分。其中导入数据检测在开发者[导入意图数据](../implement/import/index.html)后即由微信侧进行。 当所有测试通过之后，开发者可以提交发布进行服务的上线。

### 测试前注意事项

提交`后台性能测试`前，请确保后台接口已经在小程序管理端**消息推送**中配置完成，见[接入概述](https://developers.weixin.qq.com/miniprogram/dev/api/custommsg/callback_help.html?t=18092916)。
