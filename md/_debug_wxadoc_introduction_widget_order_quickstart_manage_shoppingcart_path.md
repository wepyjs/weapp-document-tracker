...
*   [中文](https://developers.weixin.qq.com/miniprogram/introduction/widget/order/quickstart/manage/shoppingcart_path.html?t=18111219)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/introduction/widget/order/quickstart/manage/shoppingcart_path.html?t=18111219)
...
*   [标准模板](../../../)
    *   [购物单](../../)
        ...
        *   [细节运营](./shoppingcart_path.html)
            *   [设置购物车源路径](./shoppingcart_path.html)
...
可以设置商户小程序的购物车页面路径。设置后，微信购物单中会有对应的入口，引导用户跳转到商家小程序的购物车页面完成购买。
...
<td style="text-align:left">https://api.weixin.qq.com/mall/brandmanage?action=set_shoppingcart_path?access_token=ACCESS_TOKEN</td>
...
<td style="text-align:left">设置商户小程序购物车页面路径</td>
...
<td style="text-align:left">商户开通微信购物单功能后</td>
...
## 请求数据样例
    ...
    {
        "shoppingcart_path": "shoppingcart/index"
    }
...
<td style="text-align:left">shoppingcart_path</td>

<td style="text-align:left">是</td>

<td style="text-align:left">string</td>

<td style="text-align:left">商户小程序购物车页面路径</td>
...
[](../goods/update.html)[](../example/userteach.html)</div>
