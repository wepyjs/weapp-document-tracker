...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/network/request/wx.request.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/network/request/wx.request.html?t=18111620)
...
*   [网络](../download/wx.downloadFile.html)
    ...
    *   [发起请求](./wx.request.html)
        ...
        *   [RequestTask](./RequestTask.html)
            *   [.abort](./RequestTask.abort.html)
            *   [.offHeadersReceived](./RequestTask.offHeadersReceived.html)
            *   [.onHeadersReceived](./RequestTask.onHeadersReceived.html)
...
### [RequestTask](RequestTask.html) wx.request(Object object)
...
<td>设置请求的 header，header 中不能设置 Referer。  
`content-type` 默认为 `application/json`</td>
...
[](../mdns/wx.offLocalServiceDiscoveryStop.html)[](../upload/wx.uploadFile.html)</div>
