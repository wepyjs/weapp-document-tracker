...
*   [中文](https://developers.weixin.qq.com/minigame/dev/document/open-api/sec-check/imgSecCheck.html?t=18081820)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/minigame/en/dev/document/open-api/sec-check/imgSecCheck.html?t=18081820)
...
<td>[Form-Data]((Form-Data))</td>

<td></td>

<td>是</td>

<td>要检测的图片文件，格式支持PNG、JPEG、JPG、GIF，图片尺寸不超过 750px * 1334px</td>
...
[](../access-token/getAccessToken.html)[](./msgSecCheck.html)</div>
