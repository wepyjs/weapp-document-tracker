...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/wx.startBluetoothDevicesDiscovery.html?t=18110616)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/device/bluetooth/wx.startBluetoothDevicesDiscovery.html?t=18110616)
...
*   [设备](../accelerometer/wx.onAccelerometerChange.html)
    ...
    *   [蓝牙](./wx.closeBluetoothAdapter.html)
...
<td>要搜索但蓝牙设备主 service 的 uuid 列表。某些蓝牙设备会广播自己的主 service 的 uuid。如果设置此参数，则只搜索广播包有对应 uuid 的主服务的蓝牙设备。建议主要通过该参数过滤掉周边不需要处理的其他蓝牙设备。</td>
...
[在开发者工具中预览效果](wechatide://minicode/pQU51zmz7a3K "在开发者工具中预览效果")
...
[](./wx.openBluetoothAdapter.html)[](./wx.stopBluetoothDevicesDiscovery.html)</div>
