...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/set-text-baseline.html?t=18110615)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/canvas/set-text-baseline.html?t=18110615)
...
![](https://developers.weixin.qq.com/miniprogram/dev/image/canvas/set-text-baseline.png?t=18110615)
