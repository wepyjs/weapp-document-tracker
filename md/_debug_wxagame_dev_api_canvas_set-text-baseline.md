...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/set-text-baseline.html?t=18090714)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/canvas/set-text-baseline.html?t=18090714)
...
![](https://developers.weixin.qq.com/miniprogram/dev/image/canvas/set-text-baseline.png?t=18082915)
