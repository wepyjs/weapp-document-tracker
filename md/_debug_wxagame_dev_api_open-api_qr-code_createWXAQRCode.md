...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/qr-code/createWXAQRCode.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/qr-code/createWXAQRCode.html?t=18101919)
...
获取小程序二维码，适用于需要的码数量较少的业务场景。**通过该接口生成的小程序码，永久有效，有数量限制**，详见[获取二维码](../../../framework/open-ability/qr-code.html)。
...
二维码的宽度，默认 430px，最小 280px，最大 1280px
...
*   与 [getWXACode](getWXACode.html) 总共生成的码数量限制为 100,000，请谨慎调用。
...
[](../sec-check/imgSecCheck.html)[](../template-message/addTemplate.html)</div>
