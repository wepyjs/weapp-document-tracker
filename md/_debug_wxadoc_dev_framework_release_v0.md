...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/release/v0.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/release/v0.html?t=18111620)
...
10.  `A` 新增 `<contact-button/>` 组件，用于显示客服会话按钮 [详情](https://developers.weixin.qq.com/miniprogram/dev/component/contact-button.html?t=18111620)
