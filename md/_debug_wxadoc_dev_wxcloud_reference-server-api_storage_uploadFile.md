...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/reference-server-api/storage/uploadFile.html?t=18110616)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/reference-server-api/storage/uploadFile.html?t=18110616)
...
*   [服务端 API 文档](../)
    ...
    *   [存储](.)
        ...
        *   [getTempFileURL](./getTempFileURL.html)
        *   [deleteFile](./deleteFile.html)
    *   [云函数](../functions/)
...
<td>[fs.ReadStream](https://nodejs.org/api/fs.html#fs_class_fs_readstream)</td>
