...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/wxml/NodesRef.html?t=18101919)
...
##### [NodesRef.fields(Object fields)](NodesRef.fields.html)

获取节点的相关信息，需要获取的字段在fields中指定。返回值是 `nodesRef` 对应的 `selectorQuery`

##### [SelectQuery NodesRef.boundingClientRect(NodesRef.boundingClientRectCallback callback)](NodesRef.boundingClientRect.html)

添加节点的布局位置的查询请求，相对于显示区域，以像素为单位。其功能类似于 DOM 的 `getBoundingClientRect`。返回 `NodesRef` 对应的 `SelectorQuery`。

##### [SelectQuery NodesRef.scrollOffset(NodesRef.scrollOffsetCallback callback)](NodesRef.scrollOffset.html)
...
[](./SelectorQuery.html)[](./IntersectionObserver.html)</div>
