...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/subpackages/basic.html?t=18110616)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/subpackages/basic.html?t=18110616)
...
<td>分包别名，[分包预下载](preload.html)时可以使用</td>
...
<td>分包是否是[独立分包](independent.html)</td>
...
[下载 小程序示例（分包加载版）源码](../../demo/demo-subpackages.zip)
