...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/set-text-baseline.html?t=18083022)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/canvas/set-text-baseline.html?t=18083022)
...
![](https://developers.weixin.qq.com/miniprogram/dev/image/canvas/set-text-baseline.png?t=18083022)
