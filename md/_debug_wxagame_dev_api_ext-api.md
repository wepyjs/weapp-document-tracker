...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/ext-api.html?t=18091021)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/ext-api.html?t=18091021)
...
获取[第三方平台](https://mp.weixin.qq.com/debug/wxadoc/dev/devtools/ext.html?t=18091021)自定义的数据字段。
...
获取[第三方平台](https://mp.weixin.qq.com/debug/wxadoc/dev/devtools/ext.html?t=18091021)自定义的数据字段的同步接口。
