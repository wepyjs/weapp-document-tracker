...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/devtools/audits.html?t=18101112)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/devtools/audits.html?t=18101112)
...
*   下载并安装 1.02.1808300 或以上版本的开发者工具，[下载地址](download.html)。
*   基础库需要切到 2.2.0 或以上版本。
...
![audits](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools/audits.png?t=18101112)
