...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/media/audio/InnerAudioContext.html?t=18092914)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/media/audio/InnerAudioContext.html?t=18092914)
...
InnerAudioContext 实例，可通过 [wx.createInnerAudioContext](wx.createInnerAudioContext.html) 接口获取实例。

#### 属性

##### string src

音频资源的地址，用于直接播放。[2.2.3](../../../framework/compatibility.html "基础库 2.2.3 开始支持，低版本需做兼容处理。") 开始支持云文件ID
...
[](./InnerAudioContext.offCanplay.html)[](./InnerAudioContext.play.html)</div>
