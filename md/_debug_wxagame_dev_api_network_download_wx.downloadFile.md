...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/network/download/wx.downloadFile.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/network/download/wx.downloadFile.html?t=18111620)
...
*   [网络](./wx.downloadFile.html)
    *   [下载](./wx.downloadFile.html)
        ...
        *   [DownloadTask](./DownloadTask.html)
            *   [.abort](./DownloadTask.abort.html)
            *   [.offHeadersReceived](./DownloadTask.offHeadersReceived.html)
            *   [.offProgressUpdate](./DownloadTask.offProgressUpdate.html)
            *   [.onHeadersReceived](./DownloadTask.onHeadersReceived.html)
            *   [.onProgressUpdate](./DownloadTask.onProgressUpdate.html)
    *   [mDNS](../mdns/wx.offLocalServiceDiscoveryStop.html)
        *   [wx.offLocalServiceDiscoveryStop](../mdns/wx.offLocalServiceDiscoveryStop.html)
        *   [wx.offLocalServiceFound](../mdns/wx.offLocalServiceFound.html)
        *   [wx.offLocalServiceLost](../mdns/wx.offLocalServiceLost.html)
        *   [wx.offLocalServiceResolveFail](../mdns/wx.offLocalServiceResolveFail.html)
        *   [wx.onLocalServiceDiscoveryStop](../mdns/wx.onLocalServiceDiscoveryStop.html)
        *   [wx.onLocalServiceFound](../mdns/wx.onLocalServiceFound.html)
        *   [wx.onLocalServiceLost](../mdns/wx.onLocalServiceLost.html)
        *   [wx.onLocalServiceResolveFail](../mdns/wx.onLocalServiceResolveFail.html)
        *   [wx.startLocalServiceDiscovery](../mdns/wx.startLocalServiceDiscovery.html)
        *   [wx.stopLocalServiceDiscovery](../mdns/wx.stopLocalServiceDiscovery.html)
    ...
    *   [上传](../upload/wx.uploadFile.html)
        ...
        *   [UploadTask](../upload/UploadTask.html)
            *   [.abort](../upload/UploadTask.abort.html)
            *   [.offHeadersReceived](../upload/UploadTask.offHeadersReceived.html)
            *   [.offProgressUpdate](../upload/UploadTask.offProgressUpdate.html)
            *   [.onHeadersReceived](../upload/UploadTask.onHeadersReceived.html)
            *   [.onProgressUpdate](../upload/UploadTask.onProgressUpdate.html)
    *   [WebSocket](../websocket/wx.closeSocket.html)
        ...
        *   [SocketTask](../websocket/SocketTask.html)
            *   [.close](../websocket/SocketTask.close.html)
            *   [.onClose](../websocket/SocketTask.onClose.html)
            *   [.onError](../websocket/SocketTask.onError.html)
            *   [.onMessage](../websocket/SocketTask.onMessage.html)
            *   [.onOpen](../websocket/SocketTask.onOpen.html)
            *   [.send](../websocket/SocketTask.send.html)
...
### [DownloadTask](DownloadTask.html) wx.downloadFile(Object object)

下载文件资源到本地。客户端直接发起一个 HTTPS GET 请求，返回文件的本地临时路径。使用前请注意阅读[相关说明](../../../framework/ability/network.html)。
...
<td>>= [1.8.0](../../../framework/compatibility.html "基础库 1.8.0 开始支持，低版本需做兼容处理。")</td>
...
[](../../media/audio/wx.createAudioContext.html)</div>
