...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/customer-message/temp-media.html?t=18102520)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/open-ability/customer-message/temp-media.html?t=18102520)
...
接收到用户消息之后，可通过 [获取临时素材接口](../../../api/open-api/customer-message/getTempMedia.html) 获取消息中的临时素材

### 上传临时素材

通过 [上传临时素材接口](../../../api/open-api/customer-message/uploadTempMedia.html) 可以上传临时素材，并在 [发送消息接口](../../../api/open-api/customer-message/sendCustomerMessage.html) 中使用。
