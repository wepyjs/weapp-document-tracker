...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/guide/init.html?t=18111421)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/guide/init.html?t=18111421)
...
接下来我们分别看看如何使用[数据库](database.html)、[存储](storage.html)和[云函数](functions.html)。
...
[](./console.html)[](./database.html)</div>
