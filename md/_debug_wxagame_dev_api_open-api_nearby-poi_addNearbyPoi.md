...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/nearby-poi/addNearbyPoi.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/nearby-poi/addNearbyPoi.html?t=18101919)
...
*   [开放接口](../authorize/wx.authorize.html)
    ...
    *   [附近的小程序](./addNearbyPoi.html)
        *   [addNearbyPoi](./addNearbyPoi.html)
        *   [deleteNearbyPoi](./deleteNearbyPoi.html)
        *   [getNearbyPoiList](./getNearbyPoiList.html)
        *   [setNearbyPoiShowStatus](./setNearbyPoiShowStatus.html)
...
##### string related_credential

经营资质证件号，必填

##### string related_address

经营资质地址，必填

##### string related_proof_material

相关证明材料照片临时素材 mediaid。经营资质主体与小程序同主体时不填;经营资质主体与小程序非同主体时必填。可通过 [uploadTempMedia](../customer-message/uploadTempMedia.html) 接口上传照片临时素材。
...
[](../customer-message/customerTyping.html)[](../plugin-management/applyPlugin.html)</div>
