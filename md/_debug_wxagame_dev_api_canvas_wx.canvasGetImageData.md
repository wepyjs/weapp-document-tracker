...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/wx.canvasGetImageData.html?t=18092914)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/canvas/wx.canvasGetImageData.html?t=18092914)
...
返回一个数组，用来描述 canvas 区域隐含的像素数据。在自定义组件下，第二个参数传入自定义组件组件实例 this，以操作组件内 <canvas> 组件。
...
<td>画布标识，传入 `<canvas>` 组件的 `canvas-id` 属性。</td>
...
**Uint8ClampedArray 图像像素点数据，一维数组，每四项表示一个像素点的**
...
[在开发者工具中预览效果](wechatide://minicode/GlCRTlmS7n27 "在开发者工具中预览效果")
...
[](../wxml/wx.createIntersectionObserver.html)[](../base/wx.canIUse.html)</div>
