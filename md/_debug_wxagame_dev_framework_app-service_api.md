...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/app-service/api.html?t=18111222)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/app-service/api.html?t=18111222)
...
小程序开发框架提供丰富的微信原生 API，可以方便的调起微信提供的能力，如获取用户信息，本地存储，支付功能等。详细介绍请参考 [API 文档](../../api/index.html)。
