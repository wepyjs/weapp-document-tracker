...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/device/battery/wx.getBatteryInfo.html?t=18110719)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/device/battery/wx.getBatteryInfo.html?t=18110719)
...
获取设备电量。同步 API [wx.getBatteryInfoSync](wx.getBatteryInfoSync.html) 在 iOS 上不可用。
...
[](../accelerometer/wx.onAccelerometerChange.html)[](../bluetooth/wx.closeBluetoothAdapter.html)</div>
