...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/share/wx.getShareInfo.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/share/wx.getShareInfo.html?t=18101919)
...
<td>包括敏感数据在内的完整转发信息的加密数据，详细见[加密数据解密算法](../../framework/open-ability/signature.html)</td>
...
<td>加密算法的初始向量，详细见[加密数据解密算法](../../framework/open-ability/signature.html)</td>
...
encryptedData 解密后为以下 json 结构，详见[加密数据解密算法](../../framework/open-ability/signature.html)。其中 openGId 为当前群的唯一标识
...
*   如需要展示群名称，可以使用[开放数据组件](../../component/open-data.html)
