...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/reference-server-api/database/db.serverDate.html?t=18111421)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/reference-server-api/database/db.serverDate.html?t=18111421)
...
<td>引用的服务端时间偏移量，毫秒为单位，可以是正数或负数</td>
...
[](../../reference-client-api/database/db.regexp.html)[](./db.geo.html)</div>
