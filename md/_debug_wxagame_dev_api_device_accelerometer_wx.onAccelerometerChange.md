...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/device/accelerometer/wx.onAccelerometerChange.html?t=18110719)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/device/accelerometer/wx.onAccelerometerChange.html?t=18110719)
...
监听加速度数据事件。频率根据 [wx.startAccelerometer()](wx.startAccelerometer.html) 的 interval 参数。可使用 [wx.stopAccelerometer()](wx.stopAccelerometer.html) 停止监听。
...
[](../../location/wx.chooseLocation.html)[](../../ui/animation/wx.createAnimation.html)</div>
