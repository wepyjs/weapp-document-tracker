...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/component/cover-view.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/component/cover-view.html?t=18111620)
...
<td>设置顶部滚动偏移量，仅在设置了 overflow-y: scroll 成为滚动元素后生效（单位px或rpx，默认为px）</td>
