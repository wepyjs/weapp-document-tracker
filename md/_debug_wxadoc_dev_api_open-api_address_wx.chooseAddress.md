...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/address/wx.chooseAddress.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/address/wx.chooseAddress.html?t=18101919)
...
*   [开放接口](../authorize/wx.authorize.html)
    ...
    *   [收货地址](./wx.chooseAddress.html)
        *   [wx.chooseAddress](./wx.chooseAddress.html)
...
> 调用前需要 [用户授权](../../../framework/open-ability/authorize.html) scope.address
...
[在开发者工具中预览效果](wechatide://minicode/024hHnmd772y "在开发者工具中预览效果")
...
[](../account-info/wx.getAccountInfoSync.html)[](../login/wx.checkSession.html)</div>
