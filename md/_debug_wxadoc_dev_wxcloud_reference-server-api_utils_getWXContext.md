...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/reference-server-api/utils/getWXContext.html?t=18110517)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/reference-server-api/utils/getWXContext.html?t=18110517)
...
*   [服务端 API 文档](../)
    *   [初始化](../init.html)
    *   [工具类](.)
        *   [getWXContext](./getWXContext.html)
    *   [数据库](../database/)
        *   [API 列表](../database/)
...
<td>小程序端调用云函数，并且[满足 unionid 获取条件](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/union-id.html?t=18110517)时</td>
