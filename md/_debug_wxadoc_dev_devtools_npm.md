...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/devtools/npm.html?t=18111421)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/devtools/npm.html?t=18111421)
...
1.  点击开发者工具中的菜单栏：工具 --> 构建 npm  
    ![construction](./image/framework/construction.png)

2.  勾选“使用 npm 模块”选项：  
    ![use npm](./image/framework/use_npm.png)
