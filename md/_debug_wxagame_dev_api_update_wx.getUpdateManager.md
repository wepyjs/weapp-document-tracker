...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/update/wx.getUpdateManager.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/update/wx.getUpdateManager.html?t=18101919)
...
### [UpdateManager](UpdateManager.html) wx.getUpdateManager()

> 支持版本 >= [1.9.90](../../framework/compatibility.html "基础库 1.9.90 开始支持，低版本需做兼容处理。")

获取**全局唯一**的版本更新管理器，用于管理小程序更新。关于小程序的更新机制，可以查看[运行机制](../../framework/operating-mechanism.html)文档。
...
[](../open-api/authorize/wx.authorize.html)[](../worker/wx.createWorker.html)</div>
