...
![sources](../image/devtools/sources.png)
...
*   开发者可以在此输入和调试代码
    ...
    ![console](../image/devtools/console1.gif)

*   小程序的错误输出，会显示在此处

    ![4](../image/devtools/4.png)
