...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.draw.html?t=18092019)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/canvas/CanvasContext.draw.html?t=18092019)
...
本次绘制是否接着上一次绘制。即 reserve 参数为 false，则在本次调用绘制之前 native 层会先清空画布再继续绘制；若 reserver 参数为 true，则保留当前画布上的内容，本次调用 drawCanvas 绘制的内容覆盖在上面，默认 false。
...
![](https://developers.weixin.qq.com/miniprogram/dev/image/canvas/reserve.png?t=18092019)
...
![](https://developers.weixin.qq.com/miniprogram/dev/image/canvas/un-reserve.png?t=18092019)
...
[](./CanvasContext.html)[](./CanvasContext.createLinearGradient.html)</div>
