...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/guide/functions/npm.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/guide/functions/npm.html?t=18111620)
...
在[下一章节](wx-server-sdk.html)，我们一起了解下官方提供的云函数端 SDK： `wx-server-sdk`。
...
[](./async.html)[](./wx-server-sdk.html)</div>
