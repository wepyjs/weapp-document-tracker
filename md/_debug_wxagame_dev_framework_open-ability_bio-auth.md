...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/bio-auth.html?t=18102614)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/open-ability/bio-auth.html?t=18102614)
...
目前暂时只支持指纹识别认证。设备支持的生物认证方式可使用 [`wx.checkIsSupportSoterAuthentication`](../../api/open-api/soter/wx.checkIsSupportSoterAuthentication.html) 查询

### 调用流程

![](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/image/soter.png?t=18102614)

#### 流程步骤说明

1.  调用 [`wx.startSoterAuthentication`](../../api/open-api/soter/wx.startSoterAuthentication.html)，获取 `resultJSON` 和 `resultJSONSignature`
