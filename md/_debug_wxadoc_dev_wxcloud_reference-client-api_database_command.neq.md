...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/reference-client-api/database/command.neq.html?t=18092115)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/reference-client-api/database/command.neq.html?t=18092115)
...
表示字段不等于某个值，和 [`db.command.eq`](command.eq.html) 相反
...
[](./command.eq.html)[](./command.lt.html)</div>
