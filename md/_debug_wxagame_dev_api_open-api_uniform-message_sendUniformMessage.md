...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/uniform-message/sendUniformMessage.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/uniform-message/sendUniformMessage.html?t=18101919)
...
*   [开放接口](../authorize/wx.authorize.html)
    ...
    *   [统一服务消息](./sendUniformMessage.html)
        *   [sendUniformMessage](./sendUniformMessage.html)
...
<td>模板id不正确，weapp_template_msg.template_id或者mp_template_msg.template_id</td>
...
<td>weapp_template_msg.form_id过期或者不正确</td>
...
<td>weapp_template_msg.page不正确</td>
...
[](../login/wx.checkSession.html)[](../access-token/getAccessToken.html)</div>
