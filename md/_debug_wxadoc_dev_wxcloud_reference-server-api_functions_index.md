...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/reference-server-api/functions/index.html?t=18110517)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/reference-server-api/functions/index.html?t=18110517)
...
*   [服务端 API 文档](../)
    ...
    *   [云函数](.)
        *   [callFunction](./callFunction.html)
...
云开发 `wx-server-sdk` 提供了以下云函数调用 API：
...
<td>[callFunction](callFunction.html)</td>
