...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/reference-server-api/database/db.geo.html?t=18091218)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/reference-server-api/database/db.geo.html?t=18091218)
    ...
    exports.main = async (event, context) => {
      try {
        return await db.collection('todos').add({
          ...
          location: new db.Geo.Point(23, 50)
        })
      } catch(e) {
        console.error(e)
      }
...
[](./db.serverDate.html)[](./command.eq.html)</div>
