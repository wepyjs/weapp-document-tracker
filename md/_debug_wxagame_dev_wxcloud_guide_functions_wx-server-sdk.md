...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/guide/functions/wx-server-sdk.html?t=18111421)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/guide/functions/wx-server-sdk.html?t=18111421)
...
更详细的 `wx-server-sdk` 文档可参见[服务端 API 文档](../../reference-server-api/index.html)。

在[下一章节](mechanism.html)，我们一起了解下云函数的运行机制。
