...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/reference-client-api/functions/callFunction.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/reference-client-api/functions/callFunction.html?t=18101919)
...
*   [小程序端 API 文档](../)
    ...
    *   [云函数](.)
        *   [wx.cloud.callFunction](./callFunction.html)
    *   [组件支持](../component/)
...
<td>局部覆写 wx.cloud.init 中定义的全局配置</td>
