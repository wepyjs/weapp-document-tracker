...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/debug/wx.getLogManager.html?t=18110719)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/debug/wx.getLogManager.html?t=18110719)
...
### [LogManager](LogManager.html) wx.getLogManager(number level)
...
> 支持版本 >= [2.3.2](../../framework/compatibility.html "基础库 2.3.2 开始支持，低版本需做兼容处理。")
...
[](../canvas/wx.canvasGetImageData.html)[](../ext/wx.getExtConfig.html)</div>
