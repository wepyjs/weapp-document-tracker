...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/plugin/component-limit.html?t=18111222)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/plugin/component-limit.html?t=18111222)
...
*   开放能力（open-type）为以下之一的 [button](../../component/button.html)：
    *   contact（打开客服会话）
...
*   [navigator](../../component/live-player.html) 需要基础库版本 [2.1.0](../compatibility.html "基础库 2.1.0 开始支持，低版本需做兼容处理。")
*   [live-player](../../component/live-player.html) 和 [live-pusher](../../component/open-data.html) 需要基础库版本 [2.3.0](../compatibility.html "基础库 2.3.0 开始支持，低版本需做兼容处理。")
...
[](./api-limit.html)[](./functional-pages.html)</div>
