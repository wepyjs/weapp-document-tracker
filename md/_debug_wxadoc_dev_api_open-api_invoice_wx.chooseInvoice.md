...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/invoice/wx.chooseInvoice.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/invoice/wx.chooseInvoice.html?t=18111620)
...
*   [开放接口](../access-token/getAccessToken.html)
    ...
    *   [发票](./wx.chooseInvoice.html)
        *   [wx.chooseInvoice](./wx.chooseInvoice.html)
        *   [wx.chooseInvoiceTitle](./wx.chooseInvoiceTitle.html)
...
> 调用前需要 [用户授权](../../../framework/open-ability/authorize.html) scope.invoice
...
<td>所选发票卡券的加密 code，报销方可以通过 cardId 和 encryptCode 获得报销发票的信息。</td>
...
请参考[微信电子发票文档](https://mp.weixin.qq.com/wiki?t=resource/res_main&id=21517918939oae3U)中，「查询报销发票信息」部分。 其中 `access_token` 的获取请参考[getAccessToken](../access-token/getAccessToken.html)文档
...
[](../data-analysis/wx.reportAnalytics.html)[](../login/wx.checkSession.html)</div>
