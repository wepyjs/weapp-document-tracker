...
*   [中文](https://developers.weixin.qq.com/miniprogram/introduction/widget/order/quickstart/example/ordercomment.html?t=18110616)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/introduction/widget/order/quickstart/example/ordercomment.html?t=18110616)
...
![](https://developers.weixin.qq.com/miniprogram/introduction/widget/order/image/ordercomment.jpg?t=18110616)

# 2\. 要求规范

为了统一用户对购物单的认知，方便开发者接入，请使用以下标准素材：

a. 订单评价页路径：使用小程序[_<navigator_>](https://developers.weixin.qq.com/miniprogram/dev/component/navigator.html?t=18110616)组件进行跳转（无需公众号关联）
