...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/media/recorder/RecorderManager.start.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/media/recorder/RecorderManager.start.html?t=18111620)
...
<td>指定录音的音频输入源，可通过 [wx.getAvailableAudioSources()](../audio/wx.getAvailableAudioSources.html) 获取当前可用的音频源</td>
...
[](./RecorderManager.resume.html)[](./RecorderManager.stop.html)</div>
