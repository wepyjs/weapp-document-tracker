...
*   [中文](https://developers.weixin.qq.com/miniprogram/introduction/widget/custom/quickstart/test/index.html?t=18110616)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/introduction/widget/custom/quickstart/test/index.html?t=18110616)
...
在后台开发完成，并且成功体验之后，可以在“自定义模板-模板管理-开发中模板”提交测试。测试包括[抽样数据评测](datatest.html)、[后台性能测试](stresstest.html)和[展示效果测试](uitest.html)3个部分。其中抽样数据评测在开发者[抽样数据评测](../implement/import/index.html)后即由微信侧进行。 当所有测试通过之后，开发者可以提交发布进行服务的上线。

### 测试前注意事项

提交`后台性能测试`前，请确保后台接口已经在微信公众平台小程序后台“消息推送”中配置完成，见[接入概述](https://developers.weixin.qq.com/miniprogram/dev/api/custommsg/callback_help.html?t=18110616)。

提交`展示效果测试`前，请确保小程序已经发布最新体验版。
