...
*   [中文](https://developers.weixin.qq.com/miniprogram/introduction/widget/func-widget/guide/overview.html?t=18110117)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/introduction/widget/func-widget/guide/overview.html?t=18110117)
...
a. 用于申请接入功能直达的公众号已获得微信认证；  
b. 小程序不属于社交、金融、医疗、资讯、游戏、电商平台等类目。

# 接入方式

开发者可通过配置或开发的方式接入功能直达。
