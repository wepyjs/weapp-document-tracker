...
*   [中文](https://developers.weixin.qq.com/miniprogram/introduction/widget/custom/quickstart/implement/testconfig.html?t=18111219)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/introduction/widget/custom/quickstart/implement/testconfig.html?t=18111219)
...
开发者可在小程序管理端进行生产环境的接口配置[接入概述](https://developers.weixin.qq.com/miniprogram/dev/api/custommsg/callback_help.html?t=18111219)。 完成配置后，开发者也可在“自定义模板-模板管理-开发中模板-实现模板-配置后台测试接口”中配置测试环境后台接口，方便开发调试。若配置了测试接口，微信后台将把搜索请求发送到该接口，小程序体验名单内的人员可以方便地在微信客户端体验和测试。

![配置后台测试接口](./image/set_test_api.png "配置后台测试接口")
