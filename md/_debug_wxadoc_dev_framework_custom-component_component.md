...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/custom-component/component.html?t=18111420)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/custom-component/component.html?t=18111420)
...
<td>组件所在页面的生命周期声明对象，支持页面的 `show` 、 `hide` 、 `resize` 生命周期</td>

<td>[2.2.3](../compatibility.html "基础库 2.2.3 开始支持，低版本需做兼容处理。") ； `resize` 为 [2.4.0](../compatibility.html "基础库 2.4.0 开始支持，低版本需做兼容处理。")</td>
