...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/reference-client-api/database/database.html?t=18091122)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/reference-client-api/database/database.html?t=18091122)
...
<td>数据库实例配置，局部覆写 wx.cloud.init 中定义的配置</td>
