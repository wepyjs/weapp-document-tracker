...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/devtools/devtools.html?t=18091218)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/devtools/devtools.html?t=18091218)
...
![devtools](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/main.png?t=18091218)

在原有功能的基础上，新增了两个开发辅助功能：

1.  使用腾讯云，快速搭建小程序后台运行环境； [详情](../qcloud/qcloud.html)
2.  申请测试报告，了解小程序在真实的移动设备上运行性能和运行效果。

![qcloud](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/qcloud.png?t=18091218) ![test](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/test.png?t=18091218)
...
[](../api/network/download/wx.downloadFile.html)[](../wxcloud/basis/getting-started.html)</div>
