...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/media/background-audio/wx.getBackgroundAudioPlayerState.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/media/background-audio/wx.getBackgroundAudioPlayerState.html?t=18101919)
...
> 从 >= [1.2.0](../../../framework/compatibility.html "基础库 1.2.0 开始支持，低版本需做兼容处理。") 开始，本接口不再维护，建议使用 [wx.getBackgroundAudioManager](wx.getBackgroundAudioManager.html) 代替
...
[](./wx.playBackgroundAudio.html)[](./wx.getBackgroundAudioManager.html)</div>
