...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/device/gyroscope/wx.onGyroscopeChange.html?t=18092914)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/device/gyroscope/wx.onGyroscopeChange.html?t=18092914)
...
监听陀螺仪数据，频率根据 [wx.startGyroscope()](wx.startGyroscope.html) 的 interval 参数。可以使用 [wx.stopGyroscope()](wx.stopGyroscope.html) 停止监听。
