...
*   [中文](https://developers.weixin.qq.com/minigame/dev/api/ad/BannerAd.html?t=18091022)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/minigame/en/dev/api/ad/BannerAd.html?t=18091022)
...
<td>banner 广告组件的宽度。最小 300，最大至 `屏幕宽度`（屏幕宽度可以通过 wx.getSystemInfoSync() 获取）。</td>
...
##### [BannerAd.onResize(function callback)](BannerAd.onResize.html)

监听隐藏 banner 广告

##### [BannerAd.offResize(function callback)](BannerAd.offResize.html)

取消监听隐藏 banner 广告

##### [BannerAd.onLoad(function callback)](BannerAd.onLoad.html)

监听banner 广告加载事件

##### [BannerAd.offLoad(function callback)](BannerAd.offLoad.html)

取消监听banner 广告加载事件

##### [BannerAd.onError(function callback)](BannerAd.onError.html)
