...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/data-analysis/getAnalysisVisitDistribution.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/data-analysis/getAnalysisVisitDistribution.html?t=18101919)
...
<td>场景 id，定义在各个 index 下不同，具体参见下方表格</td>
...
#### 访问来源 key 对应关系（index="access_source_session_cnt")，场景值说明参见 [场景值](../../../framework/app-service/scene.html)
...
[](./getAnalysisUserPortrait.html)[](./getAnalysisVisitPage.html)</div>
