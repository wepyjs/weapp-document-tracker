...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/file/wx.getSavedFileInfo.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/file/wx.getSavedFileInfo.html?t=18101919)
...
获取本地文件的文件信息。此接口只能用于获取已保存到本地的文件，若需要获取临时文件信息，请使用 [wx.getFileInfo()](wx.getFileInfo.html) 接口。
...
[](./wx.removeSavedFile.html)[](./wx.getSavedFileList.html)</div>
