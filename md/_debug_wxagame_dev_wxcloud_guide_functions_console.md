...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/guide/functions/console.html?t=18100816)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/guide/functions/console.html?t=18100816)
...
![](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/res/functions/function_test.png?t=18100816)
...
![](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/res/functions/function_log.png?t=18100816)

### 监控

在这里可以查看云函数的调用次数、运行时间、错误次数。并支持将这些数据导出。

![](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/res/functions/function_monitor.png?t=18100816)
