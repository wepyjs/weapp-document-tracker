...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/soter/wx.startSoterAuthentication.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/soter/wx.startSoterAuthentication.html?t=18101919)
...
*   [开放接口](../authorize/wx.authorize.html)
    ...
    *   [生物认证](./wx.startSoterAuthentication.html)
        *   [wx.startSoterAuthentication](./wx.startSoterAuthentication.html)
...
<td>挑战因子。挑战因子为调用者为此次生物鉴权准备的用于签名的字符串关键识别信息，将作为 `resultJSON` 的一部分，供调用者识别本次请求。例如：如果场景为请求用户对某订单进行授权确认，则可以将订单号填入此参数。</td>
...
<td>用SOTER安全密钥对 `resultJSON` 的签名(SHA256 with RSA/PSS, saltlen=20)</td>
...
[](../miniprogram-navigate/wx.navigateToMiniProgram.html)[](../setting/wx.openSetting.html)</div>
