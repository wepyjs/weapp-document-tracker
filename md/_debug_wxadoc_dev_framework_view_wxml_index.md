...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/view/wxml/index.html?t=18101112)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/view/wxml/index.html?t=18101112)
...
WXML（WeiXin Markup Language）是框架设计的一套标签语言，结合[基础组件](../../../component/index.html)、[事件系统](event.html)，可以构建出页面的结构。
