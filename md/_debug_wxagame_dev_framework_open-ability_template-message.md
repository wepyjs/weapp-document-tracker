...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/template-message.html?t=18110719)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/open-ability/template-message.html?t=18110719)
...
1.  通过模板消息管理接口获取模板 ID（详见 [模板消息管理](#模板消息管理)）
2.  在微信公众平台手动配置获取模板 ID

登录 https://mp.weixin.qq.com 获取模板，如果没有合适的模板，可以申请添加新模板，审核通过后可使用，详见 [模板审核说明](#审核说明)

![](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/image/mp-notice.jpg?t=18110719)
...
![](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/image/notice.png?t=18110719)
