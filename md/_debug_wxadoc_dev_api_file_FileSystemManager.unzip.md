...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.unzip.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/file/FileSystemManager.unzip.html?t=18101919)
...
<td>fail permission denied, unzip ${zipFilePath} -> ${destPath}</td>
...
<td>fail no such file or directory, unzip ${zipFilePath} -> "${destPath}</td>
...
[](./FileSystemManager.unlinkSync.html)[](./FileSystemManager.writeFile.html)</div>
