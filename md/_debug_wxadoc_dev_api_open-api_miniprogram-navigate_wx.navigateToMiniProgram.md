...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/miniprogram-navigate/wx.navigateToMiniProgram.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/miniprogram-navigate/wx.navigateToMiniProgram.html?t=18101919)
...
*   [开放接口](../authorize/wx.authorize.html)
    ...
    *   [小程序跳转](./wx.navigateToMiniProgram.html)
...
> 支持版本 >= [1.3.0](../../../framework/compatibility.html "基础库 1.3.0 开始支持，低版本需做兼容处理。")

打开**同一公众号下关联**的另一个小程序（注：必须是同一公众号下，而非同个 open 账号下）

注意：**接口使用限制请参考[调整说明](https://developers.weixin.qq.com/community/develop/doc/0000ac39168d50641477b725c51c01)**
...
[](../payment/wx.faceVerifyForPay.html)[](../soter/wx.startSoterAuthentication.html)</div>
