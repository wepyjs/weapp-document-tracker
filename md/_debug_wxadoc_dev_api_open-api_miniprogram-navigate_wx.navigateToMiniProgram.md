...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/miniprogram-navigate/wx.navigateToMiniProgram.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/miniprogram-navigate/wx.navigateToMiniProgram.html?t=18111620)
...
*   [开放接口](../access-token/getAccessToken.html)
    ...
    *   [小程序跳转](./wx.navigateBackMiniProgram.html)
        *   [wx.navigateBackMiniProgram](./wx.navigateBackMiniProgram.html)
        *   [wx.navigateToMiniProgram](./wx.navigateToMiniProgram.html)
...
> 支持版本 小程序 >= [1.3.0](../../../framework/compatibility.html "基础库 1.3.0 开始支持，低版本需做兼容处理。")，小游戏 >= [2.2.0](../../../framework/compatibility.html "基础库 2.2.0 开始支持，低版本需做兼容处理。")
...
<td>需要传递给目标小程序的数据，目标小程序可在 `App.onLaunch`，`App.onShow` 中获取到这份数据。</td>
...
*   在开发者工具上调用此 API 并不会真实的跳转到另外的小程序，但是开发者工具会校验本次调用跳转是否成功。[详情](https://developers.weixin.qq.com/miniprogram/dev/devtools/different.html?t=18111620#%E8%B7%B3%E8%BD%AC%E5%B0%8F%E7%A8%8B%E5%BA%8F%E8%B0%83%E8%AF%95%E6%94%AF%E6%8C%81)
*   开发者工具上支持被跳转的小程序处理接收参数的调试。[详情](https://developers.weixin.qq.com/miniprogram/dev/devtools/different.html?t=18111620#%E8%B7%B3%E8%BD%AC%E5%B0%8F%E7%A8%8B%E5%BA%8F%E8%B0%83%E8%AF%95%E6%94%AF%E6%8C%81)
...
[](./wx.navigateBackMiniProgram.html)</div>
