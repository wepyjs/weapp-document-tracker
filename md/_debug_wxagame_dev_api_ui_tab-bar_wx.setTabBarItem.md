...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/ui/tab-bar/wx.setTabBarItem.html?t=18091415)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/ui/tab-bar/wx.setTabBarItem.html?t=18091415)
...
*   [界面](../pull-down-refresh/wx.startPullDownRefresh.html)
    ...
    *   [Tab Bar](./wx.setTabBarBadge.html)
        *   [wx.setTabBarBadge](./wx.setTabBarBadge.html)
        *   [wx.removeTabBarBadge](./wx.removeTabBarBadge.html)
        *   [wx.showTabBarRedDot](./wx.showTabBarRedDot.html)
        *   [wx.hideTabBarRedDot](./wx.hideTabBarRedDot.html)
        *   [wx.showTabBar](./wx.showTabBar.html)
        *   [wx.hideTabBar](./wx.hideTabBar.html)
        *   [wx.setTabBarStyle](./wx.setTabBarStyle.html)
        *   [wx.setTabBarItem](./wx.setTabBarItem.html)
...
<td>图片路径，icon 大小限制为 40kb，建议尺寸为 81px * 81px，当 postion 为 top 时，此参数无效，不支持网络图片</td>
