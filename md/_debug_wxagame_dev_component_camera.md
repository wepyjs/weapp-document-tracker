...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/component/camera.html?t=18110517)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/component/camera.html?t=18110517)
...
系统相机。该组件是[原生组件](native-component.html)，使用时请注意相关限制。 扫码二维码功能，需升级微信客户端至6.7.3。
...
<td>在扫码识别成功时触发，仅在 mode="scanCode" 时生效</td>

<td>[2.1.0](../framework/compatibility.html "基础库 2.1.0 开始支持，低版本需做兼容处理。")支持一维码，[2.4.0](../framework/compatibility.html "基础库 2.4.0 开始支持，低版本需做兼容处理。")支持二维码</td>
