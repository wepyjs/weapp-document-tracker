...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/unionID.html?t=18091021)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/unionID.html?t=18091021)
...
2.  如果开发者帐号下存在**同主体的**公众号，并且该用户已经关注了该公众号。开发者可以直接通过[wx.login](api-login.html)获取到该用户UnionID，无须用户再次授权。

3.  如果开发者帐号下存在**同主体的**公众号或移动应用，并且该用户已经授权登录过该公众号或移动应用。开发者也可以直接通过[wx.login](api-login.html)获取到该用户UnionID，无须用户再次授权。
...
![img](https://developers.weixin.qq.com/miniprogram/dev/image/open.png?t=18091021)

绑定流程：

登录微信开放平台（open.weixin.qq.com）—管理中心—公众帐号—绑定公众帐号

![img](https://developers.weixin.qq.com/miniprogram/dev/image/union_bind.png?t=18091021)
