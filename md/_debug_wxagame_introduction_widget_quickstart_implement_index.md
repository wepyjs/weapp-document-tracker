...
*   [中文](https://developers.weixin.qq.com/miniprogram/introduction/widget/quickstart/implement/index.html?t=18092916)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/introduction/widget/quickstart/implement/index.html?t=18092916)
...
开发者在申请模板且审核通过（对新接口而言）后，即可开始实现模板。

*   [导入意图数据](import/index.html)
*   [配置后台测试接口](testconfig.html)
*   [开发后台接口](server/overview.html)
*   [调试](debug.html)
