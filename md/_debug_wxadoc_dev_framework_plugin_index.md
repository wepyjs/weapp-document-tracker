...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/plugin/index.html?t=18102216)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/plugin/index.html?t=18102216)
...
插件是对一组 js 接口、[自定义组件](../custom-component/index.html)或页面的封装，用于嵌入到小程序中使用。插件不能独立运行，必须嵌入在其他小程序中才能被用户使用；而第三方小程序在使用插件时，也无法看到插件的代码。因此，插件适合用来封装自己的功能或服务，提供给第三方小程序进行展示和使用。
...
[](../custom-component/)[](../ability/network.html)</div>
