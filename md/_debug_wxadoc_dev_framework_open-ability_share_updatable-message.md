...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/share/updatable-message.html?t=18111420)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/open-ability/share/updatable-message.html?t=18111420)
...
每条动态消息可以理解为一个活动，活动发起前需要通过 [createActivityId](../../../api/open-api/updatable-message/createActivityId.html) 接口创建 `activity_id`。后续转发动态消息以及更新动态消息都需要传入这个 `activity_id`。
...
动态消息发出去之后，可以通过 [setUpdatableMsg](../../../api/open-api/updatable-message/setUpdatableMsg.html) 修改消息内容。
