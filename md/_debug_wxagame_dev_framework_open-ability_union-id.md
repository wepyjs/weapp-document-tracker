...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/union-id.html?t=18110719)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/open-ability/union-id.html?t=18110719)
...
4.  小程序端调用[云函数](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/basis/capabilities.html?t=18110719#%E4%BA%91%E5%87%BD%E6%95%B0)时，当满足 UnionID 获取条件时可在云函数中通过 [cloud.getWXContext](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/reference-server-api/utils/getWXContext.html?t=18110719) 获取 UnionID
...
![img](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/image/open.png?t=18110719)

#### 绑定流程：

登录[微信开放平台](https://open.weixin.qq.com) — 管理中心 — 公众帐号 — 绑定公众帐号

![img](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/image/union_bind.png?t=18110719)
