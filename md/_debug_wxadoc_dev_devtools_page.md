...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/devtools/page.html?t=18091218)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/devtools/page.html?t=18091218)
...
![登录](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/login.png?t=18091218)
...
![模式选择](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/mode.png?t=18091218)
...
![新建项目](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/addproject.png?t=18091218)
...
![管理项目](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/projectmanage.png?t=18091218)

## 主界面

开发者工具主界面，从上到下，从左到右，分别为：菜单栏、工具栏、模拟器、编辑器、调试器 五大部分。

![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/parts.png?t=18091218)
...
![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/noticecenter.png?t=18091218)

用户头像右侧是控制主界面模块显示/隐藏的按钮。至少需要有一个模块显示。

![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/showandhide.gif?t=18091218)

工具栏中间，可以选择普通编译，也可以新建并选择自定义条件进行编译和预览。

通过切后台按钮，可以模拟小程序进入后台的情况

![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/background.png?t=18091218)

工具栏上提供了清缓存的快速入口。可以便捷的清除工具上的文件缓存、数据缓存、还有后台的授权数据，方便开发者调试。

工具栏右侧是开发辅助功能的区域，在这里可以上传代码、申请测试、上传腾讯云、查看项目信息

![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/righttools.png?t=18091218)

### 工具栏管理

在工具栏上点击鼠标右键，可以打开工具栏管理

![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/toolbarmanager.png?t=18091218)
...
![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/device.png?t=18091218)
...
![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/popup.png?t=18091218)

![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/poped.png?t=18091218)
