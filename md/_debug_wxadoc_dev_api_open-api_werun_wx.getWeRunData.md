...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/werun/wx.getWeRunData.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/werun/wx.getWeRunData.html?t=18111620)
...
获取用户过去三十天微信运动步数。需要先调用 [wx.login](../login/wx.login.html) 接口。步数信息会在用户主动进入小程序时更新。
...
[](../user-info/wx.getUserInfo.html)</div>
