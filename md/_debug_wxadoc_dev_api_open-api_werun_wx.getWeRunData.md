...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/werun/wx.getWeRunData.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/werun/wx.getWeRunData.html?t=18101919)
...
> 调用前需要 [用户授权](../../../framework/open-ability/authorize.html) scope.werun
...
<td>包括敏感数据在内的完整用户信息的加密数据，详细见[加密数据解密算法](../../../framework/open-ability/signature.html)。解密后得到的数据结构见后文</td>
...
[](../data-analysis/wx.reportAnalytics.html)[](../user-info/wx.getUserInfo.html)</div>
