...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/device/motion/wx.onDeviceMotionChange.html?t=18092914)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/device/motion/wx.onDeviceMotionChange.html?t=18092914)
...
设备方向变化事件，频率根据 [wx.startDeviceMotionListening()](wx.startDeviceMotionListening.html) 的 interval 参数。可以使用 [wx.stopDeviceMotionListening()](wx.stopDeviceMotionListening.html) 停止监听。
...
[](./wx.stopDeviceMotionListening.html)</div>
