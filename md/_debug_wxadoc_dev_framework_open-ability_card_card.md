...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/card/card.html?t=18092914)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/open-ability/card/card.html?t=18092914)
...
目前只有认证小程序才能使用卡券接口，可参考 [指引](https://developers.weixin.qq.com/miniprogram/product/renzheng.html?t=18092914) 进行认证。

### 接口

小程序内可以通过 [wx.addCard](../../../api/open-api/card/wx.addCard.html) 接口给用户添加卡券。通过 [wx.openCard](../../../api/open-api/card/wx.openCard.html) 让用户选择已有卡券。
...
[](../template-message.html)[](../qr-code.html)</div>
