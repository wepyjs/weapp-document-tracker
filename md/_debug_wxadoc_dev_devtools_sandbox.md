...
![](https://developers.weixin.qq.com/miniprogram/dev/image/devtools2/sandbox/sandbox-manage-game.jpg)

## 创建测试号项目

在得到了测试号的帐号信息之后，可以在开发者工具中使用此帐号信息创建项目进行开发。

![](https://developers.weixin.qq.com/miniprogram/dev/image/devtools2/sandbox/sandbox-create-project.jpg)

如图所示，打开工具并新建一个小程序项目，填入测试帐号的 appid，即可创建测试项目。

![](https://developers.weixin.qq.com/miniprogram/dev/image/devtools2/sandbox/sandbox-program.jpg)
...
![](https://developers.weixin.qq.com/miniprogram/dev/image/devtools2/sandbox/sandbox-enable-debug.jpg)
