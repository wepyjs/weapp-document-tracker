...
*   [中文](https://developers.weixin.qq.com/miniprogram/introduction/widget/quickstart/test/datatest.html?t=18092916)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/introduction/widget/quickstart/test/datatest.html?t=18092916)
...
开发者通过后台接口导入数据后，微信侧将在**7个工作日内**对导入的数据进行检测。检测结果将在**模板与组件 - Widget - 模板管理 - 模板申请单 - 提交测试 - 导入数据检测**中展示。导入的数据需要与所提供的服务强相关，且真实有效，以股票查询服务为例，所导入的股票代码与上市公司名称不应包含虚假公司与虚假代码。
