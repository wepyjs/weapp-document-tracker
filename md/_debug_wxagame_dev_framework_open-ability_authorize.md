...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/authorize.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/open-ability/authorize.html?t=18111620)
...
开发者可以使用 [wx.getSetting](../../api/open-api/setting/wx.getSetting.html) 获取用户当前的授权状态。

### 打开设置界面

用户可以在小程序设置界面（「右上角」 - 「关于」 - 「右上角」 - 「设置」）中控制对该小程序的授权状态。

开发者可以调用 [wx.openSetting](../../api/open-api/setting/wx.openSetting.html) 打开设置界面，引导用户开启授权。

### 提前发起授权请求

开发者可以使用 [wx.authorize](../../api/open-api/authorize/wx.authorize.html) 在调用需授权 API 之前，提前向用户发起授权请求。
...
<td>[wx.getLocation](../../api/location/wx.getLocation.html), [wx.chooseLocation](../../api/location/wx.chooseLocation.html), [wx.openLocation](../../api/location/wx.openLocation.html)</td>
...
<td>[wx.chooseAddress](../../api/open-api/address/wx.chooseAddress.html)</td>
...
<td>[wx.chooseInvoiceTitle](../../api/open-api/invoice/wx.chooseInvoiceTitle.html)</td>
...
<td>[wx.chooseInvoice](../../api/open-api/invoice/wx.chooseInvoice.html)</td>
...
<td>[wx.saveImageToPhotosAlbum](../../api/media/image/wx.saveImageToPhotosAlbum.html), [wx.saveVideoToPhotosAlbum](../../api/media/video/wx.saveVideoToPhotosAlbum.html)</td>
...
<td>[`<camera />`](../../component/camera.html) 组件</td>
...
**注意：`wx.authorize({scope: "scope.userInfo"})`，无法弹出授权窗口，请使用 [`<button open-type="getUserInfo"/>`](../../component/button.html)**
...
[](./union-id.html)[](./signature.html)</div>
