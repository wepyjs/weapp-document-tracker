...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/network/mdns/wx.startLocalServiceDiscovery.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/network/mdns/wx.startLocalServiceDiscovery.html?t=18111620)
...
*   [网络](../download/wx.downloadFile.html)
    ...
    *   [mDNS](./wx.offLocalServiceDiscoveryStop.html)
        *   [wx.offLocalServiceDiscoveryStop](./wx.offLocalServiceDiscoveryStop.html)
        *   [wx.offLocalServiceFound](./wx.offLocalServiceFound.html)
        *   [wx.offLocalServiceLost](./wx.offLocalServiceLost.html)
        *   [wx.offLocalServiceResolveFail](./wx.offLocalServiceResolveFail.html)
        *   [wx.onLocalServiceDiscoveryStop](./wx.onLocalServiceDiscoveryStop.html)
        *   [wx.onLocalServiceFound](./wx.onLocalServiceFound.html)
        *   [wx.onLocalServiceLost](./wx.onLocalServiceLost.html)
        *   [wx.onLocalServiceResolveFail](./wx.onLocalServiceResolveFail.html)
        *   [wx.startLocalServiceDiscovery](./wx.startLocalServiceDiscovery.html)
        *   [wx.stopLocalServiceDiscovery](./wx.stopLocalServiceDiscovery.html)
...
> 支持版本 >= [2.4.0](../../../framework/compatibility.html "基础库 2.4.0 开始支持，低版本需做兼容处理。")
...
<td>serviceType 为空</td>

</tr>

<tr>

<td>scan task already exist</td>

<td>在当前 startLocalServiceDiscovery 发起的搜索未停止的情况下，再次调用 startLocalServiceDiscovery</td>
...
[](./wx.onLocalServiceResolveFail.html)[](./wx.stopLocalServiceDiscovery.html)</div>
