...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/guide/database/add.html?t=18102520)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/guide/database/add.html?t=18102520)
...
可以在 [add API 文档](../../reference-client-api/database/collection.add.html)中查阅完整的 API 定义。

在[下一章节](read.html)，我们将学习如何使用 API 查询到刚插入的数据。
