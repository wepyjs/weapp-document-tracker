...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/media/image/wx.compressImage.html?t=18110517)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/media/image/wx.compressImage.html?t=18110517)
...
*   [媒体](../audio/wx.createAudioContext.html)
    ...
    *   [图片](./wx.chooseImage.html)
        ...
        *   [wx.compressImage](./wx.compressImage.html)
        *   [wx.getImageInfo](./wx.getImageInfo.html)
...
<td>图片路径，图片的路径，可以是相对路径、临时文件路径、存储文件路径、网络图片路径</td>
...
<td>压缩质量，范围0～100，数值越小，质量越低，压缩率越高。</td>
...
[](./wx.chooseImage.html)[](./wx.getImageInfo.html)</div>
