...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/worker/wx.createWorker.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/worker/wx.createWorker.html?t=18101919)
...
### [Worker](Worker.html) wx.createWorker(string scriptPath)

> 支持版本 >= [1.9.90](../../framework/compatibility.html "基础库 1.9.90 开始支持，低版本需做兼容处理。")

创建一个 [Worker 线程](../../framework/workers.html)，目前限制最多只能创建一个 Worker，创建下一个 Worker 前请先调用 [Worker.terminate](Worker.terminate.html)
...
[](../update/wx.getUpdateManager.html)[](../report/wx.reportMonitor.html)</div>
