...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/nearby-poi/getNearbyPoiList.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/nearby-poi/getNearbyPoiList.html?t=18101919)
...
<td>审核失败原因，`audit_status=4` 时返回</td>
...
[](./deleteNearbyPoi.html)[](./setNearbyPoiShowStatus.html)</div>
