...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/guide/database.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/guide/database.html?t=18111620)
...
如在[云开发数据库的基础介绍](../basis/capabilities.html#数据库)中所说，云开发提供了一个 JSON 数据库，本章将介绍以下内容：

*   [上手](database/getting-started.html)：用控制台创建我的第一个集合，插入我的第一条数据
*   [数据类型](database/data-type.html)：了解数据库提供的数据类型
*   [权限控制](database/permission.html)：控制集合与记录的读写权限
*   [初始化](database/init.html)：初始化数据库 API
*   [插入数据](database/add.html)
*   [读取数据](database/read.html)：读取数据
*   [构建查询条件](database/query.html)：构建简单或复杂的查询条件
*   [更新数据](database/update.html)：数据的局部更新与替换更新
*   [删除数据](database/remove.html)
*   [索引管理](database/index.html)：为字段添加索引实现高效读写

另外可参考[小程序端](../reference-client-api/database/index.html)和[云函数端](../reference-server-api/database/index.html)的数据库 API 文档
