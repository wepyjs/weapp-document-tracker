...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/guide/database/getting-started.html?t=18102520)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/guide/database/getting-started.html?t=18102520)
...
![数据库](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/res/guide/database/console_database_ui.png?t=18102520)
...
云控制台支持上传文件导入已有的数据，可[查看指引](import.html)了解如何操作。

在[下个章节](data-type.html)，我们一起了解下数据库都提供了哪些数据类型。
