...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/data-analysis/getAnalysisUserPortrait.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/data-analysis/getAnalysisUserPortrait.html?t=18101919)
...
<td>终端类型，包括 iPhone，android，其他</td>
...
<td>属性值名称，与id对应。如属性为 `province` 时，返回的属性值名称包括「广东」等。</td>
...
[](./getAnalysisDailyRetain.html)[](./getAnalysisVisitDistribution.html)</div>
