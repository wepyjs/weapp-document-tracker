...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/component/scroll-view.html?t=18110719)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/component/scroll-view.html?t=18110719)
...
<td>距顶部/左边多远时（单位px或rpx，默认为px），触发 scrolltoupper 事件</td>
...
<td>距底部/右边多远时（单位px或rpx，默认为px），触发 scrolltolower 事件</td>
...
<td>设置竖向滚动条位置（单位px或rpx，默认为px）</td>
...
<td>设置横向滚动条位置（单位px或rpx，默认为px）</td>
...
![scroll-view](https://developers.weixin.qq.com/miniprogram/dev/image/pic/scroll-view.png?t=18110719)
