...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/customer-message/sendCustomerMessage.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/customer-message/sendCustomerMessage.html?t=18101919)
...
*   [开放接口](../authorize/wx.authorize.html)
    ...
    *   [客服消息](./customerTyping.html)
        *   [customerTyping](./customerTyping.html)
        *   [getTempMedia](./getTempMedia.html)
        *   [sendCustomerMessage](./sendCustomerMessage.html)
        *   [uploadTempMedia](./uploadTempMedia.html)
...
发送客服消息给用户。详细规则见 [发送客服消息](../../../framework/open-ability/customer-message/send.html)
...
<td>发送的图片的媒体ID，通过 [新增素材接口](uploadTempMedia.html) 上传图片文件获得。</td>
...
<td>小程序消息卡片的封面， image 类型的 media_id，通过 [新增素材接口](uploadTempMedia.html) 上传图片文件获得，建议大小为 520*416</td>
...
<td>不合法的 OpenID，请开发者确认 OpenID 否是其他小程序的 OpenID</td>
...
[](./getTempMedia.html)[](./uploadTempMedia.html)</div>
