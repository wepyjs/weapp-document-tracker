...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/invoice/wx.chooseInvoiceTitle.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/invoice/wx.chooseInvoiceTitle.html?t=18101919)
...
> 调用前需要 [用户授权](../../../framework/open-ability/authorize.html) scope.invoiceTitle
...
[在开发者工具中预览效果](wechatide://minicode/GJ4S9nmQ7x2E "在开发者工具中预览效果")
...
[](../user-info/wx.getUserInfo.html)[](../card/wx.openCard.html)</div>
