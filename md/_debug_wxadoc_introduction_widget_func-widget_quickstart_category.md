...
*   [中文](https://developers.weixin.qq.com/miniprogram/introduction/widget/func-widget/quickstart/category.html?t=18111219)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/introduction/widget/func-widget/quickstart/category.html?t=18111219)
...
在正式接入功能直达前，小程序开发者需要确定接入的功能所属类目，在提交接入功能的时需要填入功能对应的类目ID，若类目与功能不符合，会被审核拒绝接入。
...
<td style="text-align:left">https://api.weixin.qq.com/widget/funcwidget/getallcategories?access_token=ACCESS_TOKEN</td>
...
<td style="text-align:left">获取功能直达类目树</td>
...
<td style="text-align:left">完整的类目树列表</td>
...
<th style="text-align:left">list字段</th>
...
<td style="text-align:left">类目ID</td>
...
<td style="text-align:left">该类目的父节点ID</td>
...
<td style="text-align:left">类目名称</td>

</tr>

<tr>

<td style="text-align:left">has_sub</td>

<td style="text-align:left">int</td>

<td style="text-align:left">是否有子节点</td>
