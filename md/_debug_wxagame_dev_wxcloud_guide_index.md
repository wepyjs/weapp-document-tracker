...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/guide/index.html?t=18111620)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/wxcloud/guide/index.html?t=18111620)
...
*   [云开发控制台](console.html)：可视化的云资源管理器
*   [初始化](init.html)：云 API 的初始化
*   [数据库开发指引](database.html)：如何上手数据库开发
*   [存储开发指引](storage.html)：如何上手云存储开发
*   [云函数开发指引](functions.html)：如何上手云函数开发
...
[](../basis/getting-started.html)[](../reference/errcode.html)</div>
