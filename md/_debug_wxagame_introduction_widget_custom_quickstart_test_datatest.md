...
*   [中文](https://developers.weixin.qq.com/miniprogram/introduction/widget/custom/quickstart/test/datatest.html?t=18111219)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/introduction/widget/custom/quickstart/test/datatest.html?t=18111219)
...
开发者通过后台接口导入数据后，微信侧将对导入的抽样数据进行评测。评测结果将在“自定义模板-模板管理-开发中模板-提交测试-抽样数据评测”中展示。导入的数据需要与所提供的服务强相关，且真实有效，以股票查询服务为例，所导入的股票代码与上市公司名称不应包含虚假公司与虚假代码。
