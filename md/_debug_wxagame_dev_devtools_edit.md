...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/devtools/edit.html?t=18100816)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/devtools/edit.html?t=18100816)
...
![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/jsautocomplete2.gif?t=18100816)

代码模板支持

![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/jsautocomplete.gif?t=18100816)

json 补全

![3](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/jsoncomplete.gif?t=18100816)

wxml 补全

![3](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools/edit4.gif?t=18100816)
...
![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/git/directory.jpg?t=18100816)
...
![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/git/contextmenu.jpg?t=18100816)

![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/git/diff.jpg?t=18100816)

### 文件编辑

存在 Git 仓库时，状态栏会展示此 Git 仓库目前的分支信息。例如，下图表明目前 Git 仓库处于 `v2` 分支。

![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/git/statusbar.jpg?t=18100816)

同时，编辑文件内容时，将会在所编辑代码左侧实时显示相对于上一版本内容的比较。

![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/git/linediff.jpg?t=18100816)
...
![](https://developers.weixin.qq.com/miniprogram/dev/devtools/image/devtools2/git/windowsreturnsettings.jpg?t=18100816)
