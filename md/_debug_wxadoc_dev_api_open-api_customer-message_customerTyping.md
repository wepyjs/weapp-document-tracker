...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/customer-message/customerTyping.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/open-api/customer-message/customerTyping.html?t=18101919)
...
下发客服当前输入状态给用户，详见 [客服消息输入状态](../../../framework/open-ability/customer-message/typing.html)
...
[](../access-token/getAccessToken.html)[](../nearby-poi/addNearbyPoi.html)</div>
