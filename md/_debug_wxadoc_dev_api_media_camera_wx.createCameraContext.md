...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/api/media/camera/wx.createCameraContext.html?t=18101919)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/api/media/camera/wx.createCameraContext.html?t=18101919)
...
### [CameraContext](CameraContext.html) wx.createCameraContext(Object this)
...
在自定义组件下，当前组件实例的this，以操作组件内 `<camera/>` 组件
...
[](../background-audio/wx.onBackgroundAudioStop.html)[](../live/wx.createLivePlayerContext.html)</div>
