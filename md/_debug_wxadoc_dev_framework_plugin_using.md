...
*   [中文](https://developers.weixin.qq.com/miniprogram/dev/framework/plugin/using.html?t=18091415)<span class="split-line">/</span>
*   [EN](https://developers.weixin.qq.com/miniprogram/en/dev/framework/plugin/using.html?t=18091415)
...
使用插件提供的自定义组件，和[使用普通自定义组件](../custom-component/)的方式相仿。在 `json` 文件定义需要引入的自定义组件时，使用 `plugin://` 协议指明插件的引用名和自定义组件名，例如：
